...
class ConfigProvider
{
    ...
    public function getCustomerDataMode($channelId = null, $languageId = null): CustomerDataMode
    {
     ...
     */
    public function shouldSendCustomerDataFromBackend($channelId = null, $languageId = null): bool
    {
    ...
    {
        return $this->configService->get(NostoConfigService::SYNC_BATCH_SIZE, null, null);
    }
}
