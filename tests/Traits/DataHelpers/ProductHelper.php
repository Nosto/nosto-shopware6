...
trait ProductHelper
{
    ...
    public function createTestProduct(
        ...
        if ($withVariant) {
            $products[] = [
                ...
                'productNumber' => 'NOSTO001.1',
                'ean' => 'NS0011',
                'manufacturerNumber' => 'MAN0011',
                'name' => 'NOSTO VARIANT 1',
                'stock' => 10,
                'active' => true,
            ...
            $products[] = [
                ...
                'productNumber' => 'NOSTO001.2',
                'ean' => 'NS0012',
                'manufacturerNumber' => 'MAN0012',
                'name' => 'NOSTO VARIANT 2',
                'stock' => 7,
                'active' => true,
                'parentId' => $mainProduct['id'],
                'tax' => ['name' => '9%', 'taxRate' => 9],
    ...
    public function createProductWithMultipleVariants(
        ...
        $variants[] = $this->getBasicVariantData([
            ...
            'parentId' => $parentId,
            'productNumber' => 'NOSTO001.3',
            'name' => 'NOSTO VARIANT 3',
            'options' => [
                ['id' => $thirdOptionId]
            ],
        ]);
    ...
    public function upsertProducts(array $productInfo): ?ProductEntity
    {
        ...
        try {
            ...
            $criteria->addAssociations(self::VARIANT_ASSOCIATIONS);
    ...
    public function buildProductInfo(
        ...
        $productData = array_merge(
            $productData,
            $this->getNameValues($overrideData['name'] ?? 'NOSTO Product')
        );

        $productData = array_merge($productData, [
            'id' => $id,
            'productNumber' => 'NOSTO001',
            'stock' => 10,
            'ean' => 'NS001',
            'description' => 'NOSTO Description',
            'tags' => [
                ['id' => Uuid::randomHex(), 'name' => 'NOSTO Tag']
            ],
